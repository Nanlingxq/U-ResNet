...
if __name__ == "__main__":
    ...
    for epoch in range(1, epochs + 1):
        ...
        if accuracy_top1 >= top:
            top = accuracy_top1
            torch.save(model.state_dict(), f'./MiniImageNetResult/VisionTransformer.pt')
        ...
        pd.DataFrame(train_list).to_excel(f'./MiniImageNetResult/Vit-MiniImageNet-TrainResult.xlsx', index=False)