...
class ShuffleNet(nn.Module):
    def __init__(self, num_classes, scale_factor=1, g=8):
        super(ShuffleNet, self).__init__()
        self.g = g
        # self.cs = {1: 144, 2: 200, 3: 240, 4: 272, 8: 384}
        self.cs = {1: 144, 2: 200, 3: 240, 4: 272, 8: 384}
        self.cs = {1: 272, 2: 544, 3: 1088, 4: 272, 8: 384}
        ...
        # build stages
        self.stage2 = self.build_stage(24, c2, repeat_time=4, first_group=False, downsample=False)
        self.stage3 = self.build_stage(c2, c3, repeat_time=8)
        self.stage4 = self.build_stage(c3, c4, repeat_time=4)
...
if __name__ == "__main__":
    ...
    net = ShuffleNet(num_classes=10, scale_factor=3).to(device)
