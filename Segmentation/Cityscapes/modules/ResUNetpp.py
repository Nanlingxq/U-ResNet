...
class build_resunetplusplus(nn.Module):
    def __init__(self, num_cls, base = 16):
        super().__init__()
        self.num_cls = num_cls
        self.name = "ResUNetPlusPlus"
        self.c1 = Stem_Block(3, base, stride=1)
        self.c2 = ResNet_Block(base, base * 2, stride=2)
        self.c3 = ResNet_Block(base * 2, base * 4, stride=2)
        self.c4 = ResNet_Block(base * 4, base * 8, stride=2)

        self.b1 = ASPP(base * 8, base * 16)

        self.d1 = Decoder_Block([base * 4, base * 16], base * 8)
        self.d2 = Decoder_Block([base * 2, base * 8], base * 4)
        self.d3 = Decoder_Block([base, base * 4], base * 2)

        self.aspp = ASPP(base * 2, base)
        self.output = nn.Conv2d(base, num_cls, kernel_size=1, padding=0)
